...
def main():
    ...
    if backend == "postgresql":
        ...
        VALUES
            ...
            ('brand_search','OUTIN','{"brand":"OUTIN","brand_aliases":["OutIn"],"query":"coffee maker"}','daily','US',2,1,'OUTIN品牌搜索(带brand过滤)','system'),
            ('category_scan','289745','{"category_name":"Coffee Machines"}','daily','US',3,1,'Home & Kitchen > Kitchen & Dining > Coffee Machines 类目扫描','system'),
            ('segment_scan','portable coffee machine','{"segment_name":"Portable Coffee Machines","target_brand":"OutIn","brand_aliases":["OUTIN"],"repeat_k":2,"top_n":50,"query_variants":["portable espresso maker"],"related_terms":["travel","compact"]}','daily','US',2,1,'自定义细分市场：便携咖啡机','system'),
